...
const Sistema: React.FC = () => {
  ...
  const [boletimId, setBoletimId] = useState<string>(''); // State for boletimId
  ...
  const handleBoletimIdChange = (id: string) => {
    setBoletimId(id);
  };
      ...
      <Layout style={{ height: '100vh', width: '100%' }}>
        ...
        <Layout className="site-layout">
                  ...
                  {
                    {
                      '4': (
                        <Board
                          ...
                          onBoletimIdChange={handleBoletimIdChange}
                        />
                      ), // Pass handleDemandIdChange as prop/>,
                      '5': (
                        <Bloco
                          setChave={setChildrenMenu}
                          onBlocoIdChange={handleBlocoIdChange}
                          boletimId={boletimId}
                        />
                      ), // Pass handleDemandIdChange as prop/>,
                      '6': (
          ...
          <Footer style={{ textAlign: 'center' }}>
            {sistemaNameSSO} ©2023Inovação e Tecnologia
          </Footer>
        </Layout>
      </Layout>
      <Modal
